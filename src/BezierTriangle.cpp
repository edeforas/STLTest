...
void BezierTriangle::set_P(const Point3 & P1, const Point3 & P2, const Point3 & P3)
{
	_P1 = P1;
	_P2 = P2;
	_P3 = P3;
...
void BezierTriangle::set_control_P(const Point3& controlP1P2, const Point3& controlP2P1, const Point3& controlP1P3, const Point3& controlP3P1, const Point3& controlP2P3, const Point3& controlP3P2)
{
...
void BezierTriangle::set_control_center(const Point3& controlCenter)
{
	_controlCenter = controlCenter;
}

void BezierTriangle::set_normals(const Point3& normalP1, const Point3& normalP2, const Point3& normalP3)
{
